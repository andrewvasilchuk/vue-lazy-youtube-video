...
| `autoplay`                              | `false`  | `boolean`                                | `false`                                                                                                                       | (Deprecated, include it in [parameters](#parameters) prop). Whether or not to play video as soon as component mounts into the DOM                                                                                                                                                                                                                                                                                                                                                                  |
| `thumbnailListeners`                    | `false`  | `Record<string, Function \| Function[]>` |                                                                                                                               | Listeners that will be attached to the preview thumbnail                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `enablejsapi`                           | `false`  | `boolean`                                | `false`                                                                                                                       | (Deprecated, include it in [parameters](#parameters) prop). Include [`'enablejapi=1'`][2] parameter to the generated `src` attribute of the `<iframe />` element. This will allow you to listen to the `init:player` event as well as access the `YT.Player` instance via the `getPlayerInstance` method. **Make sure** you have injected the proper YouTube [`<script />`](https://developers.google.com/youtube/player_parameters#IFrame_Player_API) tag or passed the `injectPlayerScript` prop |
...
| <a name="parameters">`parameters`</a>   | `false`  | `YT.Parameters`                                 | `{}`                                                                                                                          | [YouTube Parameters][5] that will be injected into the generated `<iframe />` `src` attribute                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
